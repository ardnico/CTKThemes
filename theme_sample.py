...
from themes.theme.theme import *
...
class ThemeSample(customtkinter.CTk):
    def __init__(self, **kwargs):
        ...
        self.sample_label = ThemeLabel1(self.mainframe,text="Sample")
        self.sample_label.pack()
        self.sample_labe2 = ThemeLabel2(self.mainframe,text="Sample")
        self.sample_labe2.pack()
        
        self.frame2 = ThemeFrame2(self.mainframe)
        self.frame2.pack()
